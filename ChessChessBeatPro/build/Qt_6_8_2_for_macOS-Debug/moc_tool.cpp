...
namespace {
struct qt_meta_tag_ZN4ToolE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4ToolE = QtMocHelpers::stringData(
    "Tool"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4ToolE[] = {
...
Q_CONSTINIT const QMetaObject Tool::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4ToolE.offsetsAndSizes,
    qt_meta_data_ZN4ToolE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4ToolE_t,
        // Q_OBJECT / Q_GADGET
...
void *Tool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4ToolE.stringdata0))
